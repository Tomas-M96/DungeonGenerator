...
{
    public int startXPos; //X coord of the start of the corridor
    public int startYPos; //Y coord of the start of the corridor
    ...
    public void SetupCorridor (Room room, IntRange length, IntRange roomWidth, IntRange roomHeight, int columns, int rows, bool firstCorridor)
    {
        ...
        //Cast the previous corridors direction to an int between 0 and 3 and add 2 (a number between 2 and 5)
        ...
        //If this is not the first corridor and the randomly selected direction is opposite to the previous corridors direction
        if(!firstCorridor && direction == oppositeDirection)
        {
            //Rotate the direction 90 degrees clockwise (North become East, East becomes South etc.)
            //This is a more broken down version of the opposite direction operation above but instead of adding 2 we're adding 1
            //This means insterad of rotating 180 we're rotating 90
        ...
        switch(direction)
        {
            ...
            case Direction.North:
                ...
                //The starting position in the y axis must be on the top of the room
                startYPos = room.yPos + room.roomHeight;
                //The maximum length the corridor can be is the height of the board (rows) but form the top of the room (ypos + height)
        ...
        //We clamp the length of the corridor to amke sure if doesnt go off the board
